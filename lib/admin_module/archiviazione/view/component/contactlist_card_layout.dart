...
class ArchiviazioneCardLayout extends StatefulWidget {
  ArchiviazioneCardLayout({Key? key, required this.chating})
      : super(key: key);
  final ContactLIstUserDataMessage chating;

  @override
  State<ArchiviazioneCardLayout> createState() => _ArchiviazioneCardLayoutState();
}

class _ArchiviazioneCardLayoutState extends State<ArchiviazioneCardLayout> {
  bool istrue = false;
