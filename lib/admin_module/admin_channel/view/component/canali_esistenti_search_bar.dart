...
import 'package:influencer/admin_module/admin_archived/view/component/admin_archived_emoji.dart';
...
class CanaliEsistentiSearchBarLayout extends StatefulWidget {
  const CanaliEsistentiSearchBarLayout({
    Key? key,
  }) : super(key: key);
  //  final Function(AdminArchivedMessage) adduser;

  @override
  State<CanaliEsistentiSearchBarLayout> createState() =>
      _CanaliEsistentiSearchBarLayoutState();
}

class _CanaliEsistentiSearchBarLayoutState
    extends State<CanaliEsistentiSearchBarLayout> {
