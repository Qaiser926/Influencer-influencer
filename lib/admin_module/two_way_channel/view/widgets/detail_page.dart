...
class TwoWayChating extends StatefulWidget {
  ...
  TwoWayChating({this.user});

  @override
  _TwoWayChatingState createState() => _TwoWayChatingState();
}

class _TwoWayChatingState extends State<TwoWayChating> {
