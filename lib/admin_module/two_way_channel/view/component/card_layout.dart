...
var chatData;
class TwoWayUserChannelCard extends StatelessWidget {
  const TwoWayUserChannelCard({Key? key,required this.chat}) : super(key: key);
    ...
    return GestureDetector(
                   onTap: (){
                    //  Get.toNamed(Paths.chatscreen,arguments: {chat.sender,});
                     Get.to(TwoWayChating( user: chat.sender,));
                   },
                     child: Container(
