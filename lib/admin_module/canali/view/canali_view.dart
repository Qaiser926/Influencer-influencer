...
import 'package:influencer/admin_module/canali/view/component/card_layout.dart';
...
class AdminCanali extends StatelessWidget {
  @override
    ...
    return WillPopScope(
      ...
      child: Scaffold(
       ...
       appBar: AppBar(
        ...
        title: Text(Strings.canali,style: TextStyle(color: Colors.black),),
        actions: [
          GestureDetector(
                  ...
                  children: [
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          final TwoWayMessage chat =
                              TwoWayChats[index];
                          return AdminCanaliCard(
                            chat: chat,
                          );
                        },
                      ),
