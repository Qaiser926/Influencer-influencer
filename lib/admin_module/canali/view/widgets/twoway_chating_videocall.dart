...
class CanaliVideoCall extends StatefulWidget {
  const CanaliVideoCall({Key? key}) : super(key: key);

  @override
  State<CanaliVideoCall> createState() => _CanaliVideoCallState();
}

class _CanaliVideoCallState extends State<CanaliVideoCall> {
