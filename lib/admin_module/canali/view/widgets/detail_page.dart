...
class CanaliDetailPage extends StatefulWidget {
  ...
  CanaliDetailPage({this.user});

  @override
  _CanaliDetailPageState createState() => _CanaliDetailPageState();
}

class _CanaliDetailPageState extends State<CanaliDetailPage> {
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        final bool isMe = message.sender.id == TwowayCurrentUser.id;
                  ...
                  Container(
                    child: Row(
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            Get.toNamed(Paths.CanaliVideoCall);
                          },
                          child: Padding(
                            padding: EdgeInsets.symmetric(
                                horizontal: Dimensions.fontSize12),
