...
import 'component/user_contactlist_card_layout.dart';


class UserSideContactListAdminStartChannel extends StatelessWidget {
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        physics: NeverScrollableScrollPhysics(),
                        itemCount: usersidecontactListuserChats.length,
                        itemBuilder: (BuildContext context, int index) {
                          final UserSideContactLIstUserDataMessage chat =
                              usersidecontactListuserChats[index];
                          return UserSideContactListAdminStartChannelCardLayout(
                            chating: chat,
                          );
                        },
                      ),
