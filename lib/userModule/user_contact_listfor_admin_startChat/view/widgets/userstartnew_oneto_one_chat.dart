...
import 'package:influencer/userModule/user_contact_listfor_admin_startChat/model/contact_list_modelclass.dart';
import 'package:influencer/userModule/user_contact_listfor_admin_startChat/model/userdata.dart';
...
class UserSideContactListAdminChatingOneToOne extends StatefulWidget {
  final UserSideContactListUserData? user;

  UserSideContactListAdminChatingOneToOne({this.user});

  @override
  _UserSideContactListAdminChatingOneToOneState createState() =>
      _UserSideContactListAdminChatingOneToOneState();
}

class _UserSideContactListAdminChatingOneToOneState
    extends State<UserSideContactListAdminChatingOneToOne> {
  ...
  _chatBubble(UserSideContactLIstUserDataMessage message, bool isMe, bool isSameUser) {
    if (isMe) {
      return Column(
        children: <Widget>[
          Container(
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        final UserSideContactLIstUserDataMessage message =
                            getcontactListdata[index];
                        final bool isMe = message.sender.id == usersideContactListcurrentUser.id;
