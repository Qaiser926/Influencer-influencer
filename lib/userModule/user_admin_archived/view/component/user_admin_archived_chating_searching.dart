...
class UserSideAdminArchivedChatingSearchBarLayout extends StatefulWidget {
  UserSideAdminArchivedChatingSearchBarLayout({Key? key, required this.adduser})
      : super(key: key);
  final Function(UserSideAdminArchivedMessage) adduser;

  @override
  State<UserSideAdminArchivedChatingSearchBarLayout> createState() =>
      _UserSideAdminArchivedChatingSearchBarLayoutState();
}

class _UserSideAdminArchivedChatingSearchBarLayoutState
    extends State<UserSideAdminArchivedChatingSearchBarLayout> {
