...
import 'package:influencer/userModule/user_admin_archived/view/widgets/user_admin_archived_chating.dart';

class UserSideAdminArchivedCard extends StatelessWidget {
  const UserSideAdminArchivedCard({Key? key, required this.chat}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        Get.to(UserSideAdminArchivedChatingPage(
          user: chat.sender,
        ));
      },
      child: Container(
