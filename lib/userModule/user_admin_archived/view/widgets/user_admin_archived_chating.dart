...
import 'package:influencer/userModule/user_admin_archived/controller/admin_archived_controller.dart';
import 'package:influencer/userModule/user_admin_archived/model/admin_archived_model.dart';
import 'package:influencer/userModule/user_admin_archived/model/admin_archived_modelclass.dart';
import 'package:influencer/userModule/user_admin_archived/view/component/user_admin_archived_chating_searching.dart';
...
class UserSideAdminArchivedChatingPage extends StatefulWidget {
  final UserSideAdminArchivedUser? user;

  UserSideAdminArchivedChatingPage({this.user});

  @override
  _UserSideAdminArchivedChatingPageState createState() =>
      _UserSideAdminArchivedChatingPageState();
}

class _UserSideAdminArchivedChatingPageState extends State<UserSideAdminArchivedChatingPage> {
  // @override
  // void dispose() {
  //   _controller.dispose();
  //   super.dispose();
  ...
  _chatBubble( bool isSameUser,bool isMe,UserSideAdminArchivedMessage message, ) {
    if (isMe) {
      return Column(
        children: <Widget>[
          Container(
  ...
  Widget build(BuildContext context) {
    addImage(UserSideAdminArchivedMessage image) {
      setState(() {
        usersideAdminArchiveMessages.add(image);
      });
    }
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    ...
                    child: ListView.builder(
                      ...
                      itemCount: usersideAdminArchiveMessages.length,
                      itemBuilder: (BuildContext context, int index) {
                        
                        final UserSideAdminArchivedMessage message = usersideAdminArchiveMessages[index];
                         
                        final bool isMe = message.sender.id == usersideadminarchivedcurrentuser.id;
                  ...
                  UserSideAdminArchivedChatingSearchBarLayout(
                    adduser: addImage,
                  )
